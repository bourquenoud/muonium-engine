...
namespace ue
{
  ...
  __attribute__((deprecated("Use only for testing"))) void Renderer3D::renderObject_old(const Poly &o)
  {
    // Compute the transform matrix
    ue::Vector3 offset;
    ue::Matrix4 transformMatrix;
  ...
  uint16_t Renderer3D::clipTriangle(int triangleIndex,
...
#if UE_CONFIG_COLOUR == ARGB8888 or UE_CONFIG_COLOUR == RGBA8888 or UE_CONFIG_COLOUR == ARGB1555 or UE_CONFIG_COLOUR == RGBA5551
